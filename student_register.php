<?php
 ...
 if(isset($_POST['register'])){
   ...
   $pass = $_POST['pass'];
    ...
    $insert= "INSERT INTO register(name,email,pass)
...
<html lang="en">
 ...
 <div class="row">
   ...
   <div class="Student_sing">
        <a href="index.php"> <h3 class="text-center text-uppercase pt-4 text-decoration-underline
         ">Student Registration</h3></a>
      </div>
   </div>
   <div class="col-md-6">
   <div class="S_Login-form">
      ...
      <form method="post" class="student_form">
         ...
         <span><a href="student_login.php">sigin</a></span><br>
